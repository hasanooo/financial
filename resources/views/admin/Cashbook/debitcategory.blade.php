    ...
    <div class="container">
        ...
        <div class="card bg-light p-3">
            ...
            <div class="col-12 mt-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <form action="{{ route('cashbook.select.category') }}" method="POST">
                            @csrf
                        <div class="input-group mb-3">
                            <select name="cat" id="mySelect" class="form-select form-control">
                                <option value="1" selected>Select Debit Category</option>
                                @foreach ($cat as $cat)
            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-center">
                    <h5>For the debit category of <strong>{{ $category->name }}</strong>.</h5>
                </div>
            </div>
