                ...
                <form  method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4 col-sm-12">
                            ...
                            <input type="password" class="form-control" value="{{ old('password') }}" id="email" name="password"
                                placeholder="Password">
                        </div>
                        <div class="form-group col-md-4 col-sm-12">
                            <label for="repassword">Repassword*</label>
                            <input type="password" class="form-control" value="{{ old('password_confirmation') }}" id="repassword" name="password_confirmation"
