        ...
        <table id="return_table" class="table table-bordered table-striped my-3">
            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td>{{$total_qty}}</td>
                    <td id="due">
                        @if ($due<0)<input id="payable" class="form-control" value="{{$due*(-1)}}" readonly type="number"> @else<input value="{{0}}" readonly class="form-control" id="payable" type="number"> @endif </td>
