                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body ">
                            <form action="{{route('submakepayment')}}" method="post" enctype="multipart/form-data"
                                class="row g-3">
                                {{@csrf_field()}}
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="pay_amount" class="form-control rounded-0"
             ...
             <div class="modal fade" id="exampleModaltotalpayment" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body ">
                            <form action="{{route('purmakepayment')}}" method="post" enctype="multipart/form-data"
                                class="row g-3">
                                {{@csrf_field()}}
                                ...
                                <div class="col-md-12">
                                    ...
                                    <label for="" class="form-label">Due Payment:*</label>
                                    <input type="text" class="form-control rounded-0" id="totaldue" value=""
                                        placeholder="Due Payment">
