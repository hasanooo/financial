                                                        ...
                                                        <div class="container">
                                                            <div class="form-row">
                                                                <div class="form-group col-md-4 col-sm-12">
                                                                    ...
                                                                    <input type="text" class="form-control atat"
                                                                        class="amountintotal" id="adci" name="amount"
                                                                        placeholder="0.00">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu text-left px-3 " role="menu"
                                                    ...
                                                    {{-- @if ($y->sale_invoice_sale_return->count() > 0) --}}
                                                        <li role="presentation">
                                                            <a class="btn" role="menuitem"
                                                                href=""> <i
                                                                    class="fa-solid fa-pen-to-square"></i> Refund</a>
                                                        </li>
                                                    {{-- @endif --}}
