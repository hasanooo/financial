...
<section class="content">
    <div class="row">
        <div class="col-12">
            <div class="card-body">
                <form action="{{ route('share.submit') }}" method="POST">
                    @csrf
                    <!--First Row -->
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="phone" class="form-control" style="background-color:whitesmoke;" id="" value="">
                            </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="address" class="form-control" style="background-color:whitesmoke;" id="" value="">
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="term" class="form-control" style="background-color:whitesmoke;" id="" value="">
                            </div>
                            @error('cash')
                                <span class="text-danger">{{$message}}</span><br>
                            @enderror
